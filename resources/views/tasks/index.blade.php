                                        ...
                                        <div class="card-body">
                                            <form class="edit-todo-item-checkbox" action="{{ route('tasks.toggledCompleted', [$task->id]) }}" method="POST">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <span class="display-todo-item me-5">
            ...
            $('.add-button').on('click', (e)=>{
                ...
                $.ajax({
                    ...
                    error: function(response) {
                        ...
                        toastr.options.timeOut = 3000;
                        toastr.error('There was an error adding a new task. Please try again.', 'Error');
                    }
                });
            });
            ...
            $('.save-edit-button').on('click', (e)=>{
                ...
                $.ajax({
                    ...
                    error: function(response) {
                        ...
                        toastr.options.timeOut = 3000;
                        toastr.error('There was an error saving the task name. Please try again.', 'Error');
                    }
                });
            });
